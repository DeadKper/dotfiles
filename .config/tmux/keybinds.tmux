...
# windows
bind -r p previous-window \; refresh-client -S
bind -r n next-window     \; refresh-client -S
bind -r P swap-window -t -1\; select-window -t -1 \; refresh-client -S
bind -r N swap-window -t +1\; select-window -t +1 \; refresh-client -S
