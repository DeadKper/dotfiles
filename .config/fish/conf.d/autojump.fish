...
if test -f $XDG_DATA_HOME/autojump/bin/autojump
  set -x PATH $XDG_DATA_HOME/autojump/bin $PATH
else if test -f ~/.local/share/autojump/bin/autojump
  set -x PATH ~/.local/share/autojump/bin $PATH
else if test -d ~/.autojump
